export default function ValueProp() {
  return (
    <section className="relative w-full bg-[#ecedec] pt-28 pb-28 sm:pt-32 sm:pb-32 -mt-28 sm:-mt-36 lg:-mt-52">
      <div className="relative mx-auto max-w-[900px] px-6 text-center">
        <h2 className="text-4xl font-bold leading-[1.1] tracking-tight sm:text-5xl lg:text-6xl">
          ...
          <br />
          <span className="font-semibold text-[#9ca3af]">in one place</span>
        </h2>
