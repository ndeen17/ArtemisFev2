...
export function AnalysingResumeCard() {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-6 sm:p-8">
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-[180px_1fr] gap-6 sm:gap-8 items-center">
        ...
        <div className="flex items-center justify-center">
          <div className="relative w-[160px] h-[160px]">
            <span className="absolute inset-0 rounded-full bg-[#dcfce7] motion-safe:animate-ping opacity-75" />
...
function Step({ label, delay }: { label: string; delay: string }) {
  return (
    <li className="flex items-center gap-2.5 rounded-xl bg-[#fafafa] border border-gray-100 px-3 py-2">
      <span
        className="inline-flex w-5 h-5 items-center justify-center rounded-full bg-[#dcfce7] motion-safe:animate-pulse"
