...
/** Landing — top hero section with headline, subhead, CTA, and globe illustration. */
    ...
    <main className="w-full bg-white">
      <section className="mx-auto flex max-w-[900px] flex-col items-center px-6 pt-24 text-center sm:pt-28 lg:pt-32">
        ...
        <p className="mt-6 max-w-[700px] text-base leading-relaxed text-gray-500 sm:text-lg">
          Artemis helps you improve your resume, practice real interviews, and get expert guidance —
          so you&rsquo;re actually ready when it counts.
        </p>
